...
public partial class Menu : ContentPage
{
    ...
    private void ToolbarItem_Clicked(object sender, EventArgs e)
    {
        ...
        {
            Navigation.PushAsync(new MainPage(alternativas, int.Parse(criterios.SelectedItem.ToString()), maxmin, peso));
        }
        ...
        {
            Navigation.PushAsync(new MooraPR(alternativas, int.Parse(criterios.SelectedItem.ToString()), maxmin, peso));
        }
